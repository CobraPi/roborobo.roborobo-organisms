...
#ifndef ParcoursCONTROLARCHITECTURE_H
#define ParcoursCONTROLARCHITECTURE_H
...
class ParcoursControlArchitecture : public PopulationControlArchitecture {
public:
	//Initializes the variables
	ParcoursControlArchitecture(RobotAgentWorldModel *__wm);
	virtual ~ParcoursControlArchitecture();
