...
#ifndef SCALEPOWERAGENTWORLDMODEL_H
#define SCALEPOWERAGENTWORLDMODEL_H
...
class ScalePowerAgentWorldModel : public RobotAgentWorldModel {
private:
...
public:
	...
	ScalePowerAgentWorldModel();
	virtual ~ScalePowerAgentWorldModel();
