...
#ifndef MEDEASPECIALIZESHAREDDATA_H
#define MEDEASPECIALIZESHAREDDATA_H

class MedeaSpecializeSharedData {
...
//	static int gMaxEvaluation; // how long a controller will be evaluated on a robot UNUSED
	...
	static bool gDynamicRespawn; // if true, ignore gEnergyPointRespawnLagMaxValue and use tailored MedeaSpecialize update version.
